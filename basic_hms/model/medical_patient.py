...
class medical_patient(models.Model):
    ...
    street = fields.Char(related='patient_id.street', readonly=False, tracking=True)
    street2 = fields.Char(related='patient_id.street2', readonly=False, tracking=True)
    zip_code = fields.Char(related='patient_id.zip', readonly=False, tracking=True)
    city = fields.Char(related='patient_id.city', readonly=False, tracking=True)
